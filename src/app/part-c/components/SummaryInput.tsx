...
export default function SummaryInput({ participantId, onComplete }: SummaryInputProps) {
    ...
    const handleSubmit = async () => {
        ...
        try {
            await fetch(getApiPath("/api/part-c/submit-summary"), {
                method: "POST",
    ...
    return (
        <div className="max-w-3xl mx-auto glass-panel p-10 rounded-xl shadow-sm mt-12 text-center">
            <h2 className="text-2xl font-semibold mb-6 text-[var(--foreground)]">Written Summary (Formal)</h2>
            <p className="mb-8 text-[var(--muted)] text-base">
                Please write a summary of what you have read in the Formal task.
            </p>
